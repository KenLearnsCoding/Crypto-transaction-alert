...
const (
	...
	whaleAlertApiKey = "vS6egaBiSrgbLRGubAqRWxTo9QR76zfy"            // Your Whale Alert API key
	iftttApiKey      = "eJ2UKfUpBcclbt2U-ouhnt1E4F5eRQfyk2KpQCB20Zi" // Your IFTTT API key
...
var (
	...
	subscription = AlertSubscriptionJSON{
		...
		MinValueUSD: 1_000_000, // The minimum transaction value in USD to trigger an alert
	}
